  ...
  >
    ...
    <div class="p-4">
      <div class="flex items-start gap-3">
        ...
        />
        <div v-else class="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center text-gray-500">
          {{ stream.channel_name?.charAt(0) || '?' }}
        </div>
        
        <div class="flex-1 min-w-0">
          <h3 class="font-semibold text-gray-100 truncate hover:text-pink-400 transition">
            {{ stream.title || '无标题' }}
          </h3>
          ...
          <div class="flex items-center gap-2 mt-2">
            <span 
              ...
              :class="stream.platform === 'youtube' ? 'bg-red-600/20 text-red-400' : 'bg-blue-600/20 text-blue-400'"
            >
