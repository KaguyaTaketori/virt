...
from app.services.bilibili_fetcher import get_rooms_by_uids, parse_bilibili_room
...
def start_scheduler():
    ...
    scheduler.start()
    print("[Scheduler] yt_discover=6h | yt_update=60s | bili=2min")