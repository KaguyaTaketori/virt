from sqlalchemy import (
    ...
    Enum as SQLEnum, ForeignKey, Index, Boolean, Text
)
...
class Channel(Base):
    ...
    __table_args__ = (
        Index("ix_channel_platform_active", "platform", "is_active"),
    )
...
class Stream(Base):
    ...
    platform      = Column(SQLEnum(Platform), nullable=False)
    video_id      = Column(String(100), nullable=True, index=True)  # YouTube videoId / B站 bvid
