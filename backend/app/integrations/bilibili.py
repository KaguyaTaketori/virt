...
class BilibiliService:
    """
    Bilibili 统一服务层。
    整合 API 客户端、解析器、仓库逻辑，提供完整的 Bilibili 数据访问能力。
    """
    ...
    def _parse_user_info(self, raw: dict) -> dict:
        info = raw.get("info", {})
    ...
    async def get_dynamics(
        ...
        raw_result = await self._fetch_dynamics(uid, credential, offset)
